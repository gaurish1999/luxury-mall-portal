...
export const STATS = [
  ...
  { label: 'Gross Leasable Area', value: 3.7, suffix: 'M+', prefix: '' },
...
export const RETAIL_BRANDS = [
  ...
  },
  {
    name: 'Cartier',
    category: 'Watches & Jewelry',
    image: 'https://www.cartier.com/dw/image/v2/BGTJ_PRD/on/demandware.static/-/Sites-cartier-master/default/dwa6a43eb2/images/large/8906b9f795c250f5aaa8000ceea4536d.png?sw=2000&sh=2000&sm=fit&sfrm=png',
...
export const EVENT_VENUES = [
  {
    ...
    image: '/star-atrium.webp' // AI Generated image of the Star Atrium.
  ...
  },
  {
    ...
    image: '/fashion-avenue-catwalk.webp' // AI Generated image of the Fashion Avenue Catwalk. 
  },
  {
    id: 'ice-rink',
    name: 'Dubai Ice Rink',
    ...
    image: 'https://mcpprodcdn.azureedge.net/uploads/store/elevatedPic/680f32867d79f.jpg' // From the public domain.
  },
  {
    id: 'fountain-views',
    ...
    image: 'https://mcpprodcdn.azureedge.net/uploads/store/elevatedPic/69677f022d566.jpg' // From the public domain.
  }
];
...
export const LIFESTYLE_ASSETS = [
  {
    ...
    image: 'https://mcpprodcdn.azureedge.net/uploads/advertisement/mainPicture/69d36331721d4.jpg' // From the public domain.
  },
  {
    id: 'fountain',
  ...
  },
  {
    ...
    image: 'https://mcpprodcdn.azureedge.net/uploads/store/plus1Pic/68108b8e6f5e5.jpg' // From the public domain.
  }
];